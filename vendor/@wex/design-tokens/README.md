...
This package provides CSS variables and a Tailwind CSS preset that work with [@wex/components-react](../wex-components-react), [shadcn/ui](https://ui.shadcn.com/) (React), and [Spartan UI](https://www.spartan.ng/) (Angular).
...
```bash
npm install @acme/design-tokens @wex/components-react
```

```tsx
// Uses your brand colors with WEX components
import '@acme/design-tokens/css';
import { WexButton } from '@wex/components-react';
```
