import { loadDcfsaState, saveDcfsaState } from "@/lib/dcfsaStorage";
...
export default function DcfsaPage({ currentStepId, onStepChange, onBack, onNext, onCancel }: DcfsaPageProps) {
  const initial = React.useMemo(() => loadDcfsaState(), []);
  ...
  const totalElectionCents = fsaElectionCents + lpfsaElectionCents + clampedElectionCents;
          ...
          <div className="mx-auto w-[400px] flex flex-col gap-12">
            <div className="flex flex-col gap-4">
              ...
              <div className="text-[16px] leading-6 tracking-[-0.176px] text-foreground">
                <p className="mb-0">
                  Your expenses must be incurred (service must be provided/purchase must be made) within the dates of
                  the Plan Year and, if applicable, any Plan Year extension period, to be qualified for reimbursement
                  from your Dependent Care Flex Account unless there is a special extension period (see your Summary
                  Plan Description for details.)
                </p>
                <p className="mb-0">&nbsp;</p>
                <p className="mb-0">
                  You will be reimbursed from your Dependent Care Flexible Spending Account plan up to the amount
                  contributed to date via payroll deduction.
                </p>
                <p className="mb-0">&nbsp;</p>
                <p className="mb-0">
                  Your enrollment in the Dependent Care Flexible Spending Account is binding for the entire Plan Year,
                  unless you experience a qualified change of status, such as marital status change or birth of a child.
                </p>
                <p className="mb-0">&nbsp;</p>
                <p>
            ...
            <div className="flex flex-col gap-4">
              ...
              <label className="flex items-center gap-2 text-[14px] leading-6 text-foreground">
                <WexCheckbox
                  ...
                  aria-label="I have read and understand the DCFSA rules"
                />
                <span>
