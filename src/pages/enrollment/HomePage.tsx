      ...
      <main className="flex-1 relative pt-16">
        <div className="relative max-w-[1200px] mx-auto px-6 sm:px-8 pt-10 pb-12">
          ...
          <div
            ...
            style={{
              background: HERO_CARD_BACKGROUND,
