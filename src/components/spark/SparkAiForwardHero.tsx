            ...
            {quickActions.map((action) => {
              ...
              return (
                <motion.button
                  ...
                  type="button"
                  onClick={() => {
                    if (action.assistModal === "upload-claim-documents") {
                      setUploadClaimAssistOpen(true);
                      return;
                    }
